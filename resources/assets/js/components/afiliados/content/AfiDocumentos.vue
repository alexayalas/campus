                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr v-for="(archivo, index) in archivos" :key="archivo.name">
                                            ...
                                            <td><a data-tooltip :href="archivo.url.replace('localhost','52.14.253.150')" target="_blank" data-toggle="tooltip" data-placement="top" title="" data-original-title="ver detalle">{{ archivo.name }}</a></td>
                                            <td>{{ archivo.size | returnFileSize }}</td>
                                            <td>{{ archivo.time | returnTime }}</td>
                                            <td class="text-center">
                                                <a data-tooltip :href="archivo.url.replace('localhost','52.14.253.150')" target="_blank" data-toggle="tooltip" data-placement="top" title="" data-original-title="ver detalle"><i class="fa fa-eye"></i></a>
