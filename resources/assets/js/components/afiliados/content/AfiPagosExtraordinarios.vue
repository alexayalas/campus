            ...
            <div class="panel-body">
                ...
                styleClass="table condensed table-bordered table-striped">
                    <template slot="table-row" slot-scope="props">
                        <td>{{ props.row.pago_extraordinario.nombre }}</td>
                ...
                <form data-sample-validation-1 class="form-horizontal form-bordered" role="form" method="POST" v-on:submit.prevent="createPago">
                    <div class="form-body">
                        <div class="col-md-11 pt-20">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Importe <span class="asterisk">*</span></label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="descripcion" rows="4" cols="78" v-model="dataPago.observaciones"></textarea>
                                </div>
                            </div><!-- /.form-group -->                                        
...
export default {
    ...
    computed: {
        ...mapState(['tipo_pagosextraordinarios'])
    }, 
        methods: {
            LoadForm: function(){
                this.dataPago = {
